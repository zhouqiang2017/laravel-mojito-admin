        ...
        <el-dialog :title="$t('changePassword')" :visible.sync="dialogChangePasswordFormVisible" width="30%">
            <el-form :model="changePasswordForm" :rules="rules" ref="changePasswordForm">
                <el-form-item :label="$t('oldPassword')" prop="old_password" :label-width="formLabelWidth">
                    <el-input v-model="changePasswordForm.old_password" type="password" autocomplete="off" minlength="8"
                              maxlength="12"></el-input>
                </el-form-item>
                <el-form-item :label="$t('password')" prop="password" :label-width="formLabelWidth">
                    <el-input v-model="changePasswordForm.password" type="password" autocomplete="off" minlength="8"
                              maxlength="12"></el-input>
                </el-form-item>
                <el-form-item :label="$t('confirmPassword')" prop="password_confirmation" :label-width="formLabelWidth">
                    <el-input v-model="changePasswordForm.password_confirmation" type="password" autocomplete="off"
                              minlength="8" maxlength="12"></el-input>
                </el-form-item>
            </el-form>
            ...
            return {
                ...
                rules: {
                    old_password: [
                        ...
                        {min: 8, max: 12, message: '密码必须6-12位'}
                    ],
                    password: [
                    ...
                    password_confirmation: [
                        ...
                        {validator: confirmPassword, message: '两次密码必须一致'},
                        {min: 8, max: 12}
                    ]
                }
            }
